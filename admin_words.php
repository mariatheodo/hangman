...
//γίνεται έλεγχος για δημιουργία επόμενης σελίδας και αντίστοιχων κουμπιών
$next = $page + 1;
$last = $page - 1;
if ($page == 0) {
	if ($num > $limit) {
		echo "<a href='admin_words.php?page=".$next."'><button class='btn btn-default'>Επόμενες λέξεις</button></a>";
	}
	else {}
}
else if ($page > 0 && $left > $limit) {
	echo "<a href='admin_words.php?page=".$last."'><button class='btn btn-default'>Προηγούμενες λέξεις</button></a>  ";
	echo "<a href='admin_words.php?page=".$next."'><button class='btn btn-default'>Επόμενες λέξεις</button></a>";
}
else if($left < $limit) {
	echo "<a href='admin_words.php?page=".$last."'><button class='btn btn-default'>Προηγούμενες λέξεις</button></a>";
...
<a href="search_words.php?page=<?php echo $page; ?>"><button class="btn btn-default btn-lg">Αναζήτηση λέξης</button></a>
